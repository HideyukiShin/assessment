...
userNameInpupt.onkeydown = event => {
...
assessmentButton.onclick = function() {
    ...
    paragaph.setAttribute('class', 'card-text');
    const result = assessment(userName);
    paragaph.innerText = result;
    bodyDivided.appendChild(paragaph);
...
console.log(assessment('hideyuki'));

console.assert(assessment('hideyuki') === assessment('hideyuki'), 'The output differs even when same name');